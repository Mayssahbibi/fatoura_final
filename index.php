    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Votre partenaire dans toutes vos transactions </h2>
          ...
          <div class="row gy-4" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="col-lg-3 col-6">
              <div class="stats-item text-center w-100 h-100">
                <span data-purecounter-start="0" data-purecounter-end="7000000" data-purecounter-duration="1" class="purecounter"></span>
                <p>Clients</p>
              </div>
            </div>
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
          <img src="assets1/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
        </div>
 ...
 <section id="featured-services" class="featured-services">
  <div class="container d-flex justify-content-center">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-md-6 service-item d-flex align-items-center" data-aos="fade-up" style="margin-right: 1.5cm;">
        <div class="icon flex-shrink-0 me-3"><i class="fa-solid fa-cart-flatbed"></i></div>
        <div>
          <h4 class="title">Stockage</h4>
          <p class="description">Nos dépôts de stockage sont à votre disposition pour toutes vos opérations.</p>
        </div>
      </div>
    
      <div class="col-lg-4 col-md-6 service-item d-flex align-items-center" data-aos="fade-up" data-aos-delay="100">
        <div class="icon flex-shrink-0 me-3"><i class="fa-solid fa-truck"></i></div>
        <div>
          <h4 class="title">Service Rapide</h4>
          <p class="description">Votre facture livrée en 24H.<br>Nos agences sont ouvertes de 8h à 17h - 5/7.</p>
        </div>
      </div>
  ...
  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
    <div class="card">
      <div class="card-img">
        <img src="assets1/img/facture.jpg" alt="" class="img-fluid">
      </div>
      <h3> Chargement </h3>
      <p> Enregistrement des achats en ligne </p>
    </div>
  </div><!-- End Card Item -->
</div>
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            ...
            <li><a href="home.php">Se Conneter</a></li>
            <li><a href="register.php">S'inscrire</a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          <h4>Contact Us</h4>
          <p>
          Tunisie Telecom - Direction Centrale des Finances <br>
           1002 Montplaisir - Tunis<br>
           Tunis - Tunisia <br><br>
            <strong>Téléphone:</strong> +216 71 001 298 <br>
            <strong>Email:</strong> info@ttFacture.tn<br>
          </p>
